...
function Hero() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center w-full  relative text-white border-b-2 border-primary ">
      <div className="absolute inset-0">
        <Image
          ...
          priority
        />
        <div className="bg-gradient-to-b to-black/90 from-black/40 absolute inset-0 z-10" />
      </div>
      {/* Content Container */}
      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            name="address"
            required
            className="w-full mt-2 px-3 py-2 resize-none appearance-none bg-transparent outline-none border focus:border-primary shadow-sm rounded-lg"
          ></textarea>
        </div>
        <button
